...
using VOD.UI.Models.DTOModels;
using VOD.UI.Models.MembershipViewModels;
using VOD.UI.Repositories;
...
namespace VOD.UI.Controllers
{
    public class MembershipController : Controller
    {
        ...
        public MembershipController(IHttpContextAccessor httpContextAccessor, UserManager<User> userManager, IMapper mapper, IReadRepository repo)
        {
        ...
        {
            var courseDtoObjects = _mapper.Map<List<CourseDTO>>(_repo.GetCourses(_userId));
        ...
        {
            var course = _repo.GetCourse(_userId, id);
        ...
        {
            var video = _repo.GetVideo(_userId, id);
            var course = _repo.GetCourse(_userId, video.CourseId);
            ...
            var videos = _repo.GetVideos(_userId, video.ModuleId).ToList();
